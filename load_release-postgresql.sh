...
echo "" >> ${generatedLoadScript}
addLoadScript sct2_Concept_TYPE_ArgentinaEdition_DATE.txt concept
addLoadScript sct2_Description_TYPE_ArgentinaEdition_DATE.txt description
addLoadScript sct2_StatedRelationship_TYPE_ArgentinaEdition_DATE.txt stated_relationship
addLoadScript sct2_Relationship_TYPE_ArgentinaEdition_DATE.txt relationship
addLoadScript sct2_TextDefinition_TYPE_ArgentinaEdition_DATE.txt textdefinition
addLoadScript der2_cRefset_AttributeValueTYPE_ArgentinaEdition_DATE.txt attributevaluerefset
addLoadScript der2_cRefset_LanguageTYPE_ArgentinaEdition_DATE.txt langrefset
addLoadScript der2_cRefset_AssociationTYPE_ArgentinaEdition_DATE.txt associationrefset
